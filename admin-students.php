...
<head>
    ...
    <link rel="stylesheet" href="stylesheets/admin/students.css">
...
<body>
    ...
    <main>
        ...
        <h1 class="students-title">Students</h1>
            <select name="instruments" id="instruments" class="choose-instruments">
        ...
        <div class="students-grid">
            ...
            ?></div>
            <div><?php 
            $a = $_SESSION['student_age'];
            echo $a;
            ?></div>
            <div><?php 
            $a = $_SESSION['student_address'];
            echo $a;
            ?></div>
            <div><?php 
            $a = $_SESSION['student_contact'];
            echo $a;
            ?></div>
            <div><?php 
            $a = $_SESSION['student_level'];
            echo $a;
            ?></div>
            <div>PAID</div>
        </div>
